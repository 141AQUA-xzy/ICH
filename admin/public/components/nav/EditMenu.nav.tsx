...
const LATEST_MENU = "https://restaurantapis.onrender.com/admin/menu";
const API_URL = "https://restaurantapis.onrender.com/admin/menu-edit";
...
// const LATEST_MENU = "https://restaurantapis.onrender.com/admin/menu"; // ✅ Fetch latest menu
// const API_URL = "https://restaurantapis.onrender.com/admin/menu-edit"; // ✅ Update menu endpoint
