...
// import { mainCourseDalData, mainCourseRiceData, SabjiData, raitaData, rotiParathaData, saladData } from '../iterables/MainCourse.iterable';
...
//   ],
//   prices: { standard: 79, ultimate: 99 },
// };
...
//     { image: "/assets/ThaliHouse/salad.png", name: "Salad" },
//   ],
//   prices: { standard: 109, ultimate: 129 },
// };
...
//     { image: "/assets/ThaliHouse/salad.png", name: "Salad" },
//   ],
//   prices: { standard: 119, ultimate: 139 },
// };
...
//   ],
//   prices: { standard: 139, ultimate: 159 },
// };
...
//               <a href="tel:+917828596257" className='rounded-lg bg-[#14213d] text-[#FCA331] text-center'> <CallIcon />{" "}ENQUIRE NOW</a>
//             </div>
//             <div className='flex-1 bg-[#FCA331] rounded-2xl flex flex-col justify-center p-1'>
...
//             <ThaliHouse
//               {...studentThaliData}
//               onStandardClick={() => handleStandardClick(studentThaliData.title, studentThaliData.prices.standard, "LT", studentThaliData.banner)}
//               onUltimateClick={() => handleUltimateClick(studentThaliData.title, studentThaliData.prices.ultimate, "ULT", studentThaliData.banner)}
//             />
//             <ThaliHouse
//               {...standardThaliData}
//               onStandardClick={() => handleStandardClick(standardThaliData.title, standardThaliData.prices.standard, "LT", standardThaliData.banner)}
...
//             <ThaliHouse
//               {...executiveThaliData}
//               onStandardClick={() => handleStandardClick(executiveThaliData.title, executiveThaliData.prices.standard, "LT", executiveThaliData.banner)}
...
//             <ThaliHouse
//               {...premiumThaliData}
//               onStandardClick={() => handleStandardClick(premiumThaliData.title, premiumThaliData.prices.standard, "LT", executiveThaliData.banner)}
//               onUltimateClick={() => handleUltimateClick(premiumThaliData.title, premiumThaliData.prices.ultimate, "ULT", executiveThaliData.banner)}
//             />
//           </div>
//         </div>
//       </section>
...
//             {mainCourseDalData.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
...
//           <div className='w-max h-full flex relative carouselX'>
//             {mainCourseRiceData.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
...
//         </div>
//         <div className='h-max flex flex-col bg-gradient-to-r from-[rgba(20,33,61,0.3)] to-[rgba(252,163,17,0.4)] grow rounded-2xl overflow-x-scroll'>
//           <text className='bg-[#FCA331] text-black sticky left-0 text-center w-full'>SABJI</text>
//           <div className='w-max h-max flex relative carouselx'>
//             {SabjiData.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
...
//         </div>
//         <div className='h-max flex flex-col bg-gradient-to-r from-[rgba(20,33,61,0.3)] to-[rgba(252,163,17,0.4)] grow rounded-2xl overflow-x-scroll'>
//           <text className='bg-[#FCA331] text-black sticky left-0 text-center w-full'>ROTI / PARATHA</text>
//           <div className='w-max h-full flex relative carouselX'>
//             {rotiParathaData.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
//                 price_hf={item.price_hf}
//                 ffClicked={() => { addToCart({ itemName: item.title, code: "SL", quantity: 1, price: item.price_fl ?? 0, img: item.img }) }}
//                 hfClicked={() => { addToCart({ itemName: item.title, code: "HF", quantity: 1, price: item.price_hf ?? 0, img: item.img }) }}  // 👈 Only added if `hfClicked` exists
//                 price_fl={item.price_fl}
//               // {...(item.hfClicked ? { hfClicked: item.hfClicked } : {})} // ✅ Only adds `hfClicked` if it exists
//               />
...
//         </div>
//         <div className='h-max flex flex-col bg-gradient-to-r from-[rgba(20,33,61,0.3)] to-[rgba(252,163,17,0.4)] grow rounded-2xl overflow-x-scroll'>
//           <text className='bg-[#FCA331] text-black sticky left-0 text-center w-full'>RAITA</text>
//           <div className='w-max h-full flex relative carouselX'>
//             {raitaData.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
...
//           <text className='bg-[#FCA331] text-black sticky left-0 text-center w-full'>SALAD</text>
//           <div className='w-max h-full flex relative carouselX'>
...
//           <div className='w-max h-full flex relative carouselX'>
//             {chineseRiceMenu.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
...
//           <div className='w-max h-full flex relative carouselX'>
//             {chineseStarterMenu.map((item, index) => (
//               <MainCourse
//                 img={item.img}
//                 key={index}
//                 title={item.title}
