...
const PendingApproval = () => {
    ...
    return (isLoading ? <Loading /> :
        <div className='text-white flex flex-col justify-center items-center h-dvh w-full gap-2'><kbd>Pending Approval</kbd>
            <Link onClick={() => showLoading} href="/order-bag" className='border bg-amber-400 rounded-2xl p-2 text-black'><DvrIcon />{" "}TRACK ORDERS</Link>
